...
public class ResearcherAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String outputString = researcherObj.insertUsers(
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
				...
				String output = researcherObj.updateUsers(
					paras.get("hidItemIDSave").toString(), 
					paras.get("name").toString(), 
					paras.get("surname").toString(), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = researcherObj.deleteUsers(paras.get("userID").toString()); 
		response.getWriter().write(output);
